...
---restore activities
select h.destination_database_name, h.restore_date, h.user_name, 
b.user_name, backup_start_date , f.physical_device_name
from msdb.dbo.restorehistory h 
inner join msdb.dbo.backupset b on b.backup_set_id = h.backup_set_id
